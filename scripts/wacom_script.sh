...
#
# CONFIGURATION
# Curtesy of https://bitbucket.org/denilsonsa/small_scripts/src/3380435f92646190f860b87f566a39d0e215034c/xsetwacom_my_preferences.sh?at=default

# Set this to your (stylus) device. Find it by running:
# xsetwacom --list devices
DEVICE='Wacom Bamboo Connect Pen stylus'
